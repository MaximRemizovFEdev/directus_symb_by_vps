...
Обязательные значения и способы получения описаны в [TOKENS_AND_SECRETS.md](TOKENS_AND_SECRETS.md).
...
Точные переменные: [TOKENS_AND_SECRETS.md](TOKENS_AND_SECRETS.md). Полная проверка уведомлений: [NOTIFICATIONS_SETUP.md](NOTIFICATIONS_SETUP.md).
